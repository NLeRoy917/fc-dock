...
sudo cp src/options/pH_pack.wts ./WT/pre-packing/
...
sudo cp src/options/pH_pack.wts ./LS/pre-packing/
...
sudo cp src/options/pH_pack.wts ./YTE/pre-packing/
...
sudo cp src/options/pH_pack.wts ./YTE-LS/pre-packing/
...
# Move Mouse files and set up mouse directorisudo rm es
...
sudo cp src/options/pH_pack.wts ./mouse/pre-packing/
